...
This file is generated design context for Superdesign. It is the source of truth for the production app shell and its desktop/mobile navigation variants. It intentionally includes the full source of each layout file.

## App.tsx

- Path: `src/web/src/App.tsx`
- Purpose: Production app shell and the render branches for the library and queue workspaces.
...
- Path: `src/web/src/components/AppHeader.tsx`
- Purpose: Desktop workspace heading and primary actions.
...
- Path: `src/web/src/components/AppSidebar.tsx`
- Purpose: Persistent desktop brand, queue, and category navigation.
...
- Path: `src/web/src/components/MobileHeader.tsx`
- Purpose: Compact mobile/tablet page header and primary actions.
...
- Path: `src/web/src/components/MobileNavigation.tsx`
- Purpose: Radix mobile drawer containing queue and category navigation.
